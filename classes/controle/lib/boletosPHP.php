...
class boletosPHP {
    ...
    public function verificar(){
      ...
      return (substr($this -> barras, 4, 1) == substr($this -> ipte, 38, 1));      
    }
    //Desenhar barras
    public function desenhaBarras(){
        ...
        <div style="overflow:hidden;width:417px;height:50px;">
            <img src="img/p.gif" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
    ...
    public function calcVerificadorBarras($barras) {
    ...
    public function calcDtVencimento($fator) {
